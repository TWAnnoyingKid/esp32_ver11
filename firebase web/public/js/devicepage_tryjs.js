...
function addItems(devicestop, a){
    ...
    devicediv.style.borderRadius  = "10px"
    ...
    if (devicestop.replace('"', '').split(" ")[2].replace('"', '') == "3stat"){
        ...
        do{
            ...
            // div.style.width = "35%"
            // div.style.height = "20%"
            // div.style.backgroundColor = "#16164e"
        ...
        cTag.innerHTML = "*C"
        cTag.style.fontSize  = "0.8em"
        cTag.style.fontWeight  = "700"
        ...
        devicediv.innerHTML = devicestop.replace('"', '').split(" ")[2].replace('"', '')
        p.innerHTML="  "
        _devicestop.class = a
